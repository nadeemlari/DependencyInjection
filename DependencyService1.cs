...
namespace DependencyInjection
{
    public class DependencyService1
    {
        ...
        public DependencyService1(IOperationSingletonInstance singletoninstance,IOperationTransient transient,IOpertionScoped scoped,IOperationSingleton singleton)
        {
